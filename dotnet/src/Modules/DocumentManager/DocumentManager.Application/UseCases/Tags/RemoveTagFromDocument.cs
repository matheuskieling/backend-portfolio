...
public sealed class RemoveTagFromDocumentHandler
{
    ...
    public RemoveTagFromDocumentHandler(
    ...
    public async Task HandleAsync(
        RemoveTagFromDocumentCommand command,
        CancellationToken cancellationToken = default)
    {
        var userId = _currentUserService.UserId
            ?? throw new InvalidOperationException("User must be authenticated to remove a tag from a document.");
