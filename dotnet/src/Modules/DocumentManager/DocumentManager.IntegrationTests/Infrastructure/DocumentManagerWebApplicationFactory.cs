...
/// <summary>
/// WebApplicationFactory for DocumentManager module integration tests.
/// Inherits common configuration from PortfolioWebApplicationFactoryBase.
/// </summary>
public class DocumentManagerWebApplicationFactory : PortfolioWebApplicationFactoryBase
{
    public DocumentManagerWebApplicationFactory(string connectionString) : base(connectionString)
    {
    }
